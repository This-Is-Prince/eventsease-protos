...
const (
	...
	EventService_UpdateEvent_FullMethodName      = "/eventsease.v1.EventService/UpdateEvent"
	EventService_DeleteEvent_FullMethodName      = "/eventsease.v1.EventService/DeleteEvent"
...
func (UnimplementedEventServiceServer) ToggleSavedEvent(context.Context, *ToggleSavedEventRequest) (*ToggleSavedEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ToggleSavedEvent not implemented")
}
