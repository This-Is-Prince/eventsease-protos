...
const (
	UserService_CheckUser_FullMethodName     = "/eventsease.v1.UserService/CheckUser"
	UserService_RegisterFCM_FullMethodName   = "/eventsease.v1.UserService/RegisterFCM"
	UserService_GetProfile_FullMethodName    = "/eventsease.v1.UserService/GetProfile"
	UserService_UpdateProfile_FullMethodName = "/eventsease.v1.UserService/UpdateProfile"
)
...
type UserServiceClient interface {
	...
	RegisterFCM(ctx context.Context, in *RegisterFCMRequest, opts ...grpc.CallOption) (*RegisterFCMResponse, error)
...
func (c *userServiceClient) RegisterFCM(ctx context.Context, in *RegisterFCMRequest, opts ...grpc.CallOption) (*RegisterFCMResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterFCMResponse)
	err := c.cc.Invoke(ctx, UserService_RegisterFCM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	RegisterFCM(context.Context, *RegisterFCMRequest) (*RegisterFCMResponse, error)
...
func (UnimplementedUserServiceServer) RegisterFCM(context.Context, *RegisterFCMRequest) (*RegisterFCMResponse, error) {
...
func _UserService_RegisterFCM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterFCMRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).RegisterFCM(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_RegisterFCM_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).RegisterFCM(ctx, req.(*RegisterFCMRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "eventsease.v1.UserService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_RegisterFCM_Handler,
		},
		{
